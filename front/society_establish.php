 ...
 method="post" name="contact_form" enctype="multipart/form-data">
    <ul>
        <li>
            ...
            <input name="society_name" type="text"  placeholder="6~20个字符" onfocus="outline_new(this)" onblur="outline_old(this)" />
        </li>
        <li>
        ...
        <li>
            ...
            <textarea name="describe" placeholder="不超过400个字符"  onfocus="outline_new(this)" onblur="outline_old(this)"></textarea>
        </li>
        <li>
...
<div class="email" id="email_box" style="display:none;">
    ...
    <p>~~~~只差最后一步了呢！</p>
    <input name="email" type="email"  placeholder="请在此输入您的邮箱" onfocus="outline_new(this)" onblur="outline_old(this)" />
