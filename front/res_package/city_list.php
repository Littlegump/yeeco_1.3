<?php
	...
	exit;
		...
		echo '<option id="city" selected="selected" value="">城市</option><option value="60028001">西宁市</option><option value="60028002">海东地区</option><option value="60028003">海北藏族自治州(海晏县西海镇)</option><option value="60028004">海南藏族自治州</option><option value="60028005">黄南藏族自治州</option><option value="60028006">果洛藏族自治州</option><option value="60028007">玉树藏族自治州</option><option value="60028008">海西蒙古族藏族自治州</option></select>';
	exit;
	}else if( $pro == '新疆' ){
	...
	exit;
		...
		echo '<option id="city" selected="selected" value="">城市</option><option value="拉萨市">拉萨市</option><option value="那曲地区">那曲地区</option><option value="昌都地区">昌都地区</option><option value="林芝地区">林芝地区(林芝县八一镇)</option><option value="山南地区">山南地区</option><option value="日喀则地区">日喀则地区</option><option value="阿里地区">阿里地区</option></select>';
	exit;
	}else if( $pro == '香港' ){
